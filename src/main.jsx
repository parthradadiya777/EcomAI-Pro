...
import "./styles.css";
import {MARKETPLACE_RULES, detectMarketplaceTemplate, marketplaceImageField as platformImageField} from "./platforms/registry";
...
function ListingAI({product,onBack}){
  ...
  const detectMarketplaceFromWorkbook=(matrix,sheetNames=[])=>detectMarketplaceTemplate(matrix,sheetNames);
