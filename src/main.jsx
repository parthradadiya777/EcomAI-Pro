...
function ListingAI({product,onBack}){
  ...
  */
  ...
  return <div className="content">
    ...
    <section className="listing-step-card platform-settings-card">
      ...
      <div style={{display:"grid",gridTemplateColumns:"minmax(220px,1fr) 2fr",gap:16,alignItems:"start"}}>
        ...
        {marketplace==="Meesho"&&<div style={{display:"grid",gridTemplateColumns:"repeat(4,minmax(150px,1fr))",gap:10}}>
          <label key="brand" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Brand</span><input value={platformDefaults.Meesho.brand} onChange={e=>setPlatformDefaults(p=>({...p,Meesho:{...p.Meesho,[k]:e.target.value}}))} placeholder="e.g. Jipro"/></label><label key="weight" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Weight (g)</span><input value={platformDefaults.Meesho.weight} onChange={e=>setPlatformDefaults(p=>({...p,Meesho:{...p.Meesho,[k]:e.target.value}}))} placeholder="e.g. 500"/></label><label key="countryOfOrigin" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Country of Origin</span><input value={platformDefaults.Meesho.countryOfOrigin} onChange={e=>setPlatformDefaults(p=>({...p,Meesho:{...p.Meesho,[k]:e.target.value}}))} placeholder="India"/></label><label key="inventory" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Inventory</span><input value={platformDefaults.Meesho.inventory} onChange={e=>setPlatformDefaults(p=>({...p,Meesho:{...p.Meesho,[k]:e.target.value}}))} placeholder="e.g. 100"/></label><label key="gst" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>GST %</span><input value={platformDefaults.Meesho.gst} onChange={e=>setPlatformDefaults(p=>({...p,Meesho:{...p.Meesho,[k]:e.target.value}}))} placeholder="e.g. 5"/></label><label key="hsn" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>HSN</span><input value={platformDefaults.Meesho.hsn} onChange={e=>setPlatformDefaults(p=>({...p,Meesho:{...p.Meesho,[k]:e.target.value}}))} placeholder="e.g. 6204"/></label><label key="manufacturer" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Manufacturer</span><input value={platformDefaults.Meesho.manufacturer} onChange={e=>setPlatformDefaults(p=>({...p,Meesho:{...p.Meesho,[k]:e.target.value}}))} placeholder="Manufacturer name"/></label><label key="packer" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Packer</span><input value={platformDefaults.Meesho.packer} onChange={e=>setPlatformDefaults(p=>({...p,Meesho:{...p.Meesho,[k]:e.target.value}}))} placeholder="Packer name"/></label>
        </div>}
        {marketplace==="Myntra"&&<div style={{display:"grid",gridTemplateColumns:"repeat(4,minmax(150px,1fr))",gap:10}}>
          <label key="brand" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Brand</span><input value={platformDefaults.Myntra.brand} onChange={e=>setPlatformDefaults(p=>({...p,Myntra:{...p.Myntra,[k]:e.target.value}}))}/></label><label key="countryOfOrigin" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Country Of Origin</span><input value={platformDefaults.Myntra.countryOfOrigin} onChange={e=>setPlatformDefaults(p=>({...p,Myntra:{...p.Myntra,[k]:e.target.value}}))}/></label><label key="manufacturer" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Manufacturer</span><input value={platformDefaults.Myntra.manufacturer} onChange={e=>setPlatformDefaults(p=>({...p,Myntra:{...p.Myntra,[k]:e.target.value}}))}/></label><label key="packer" className="field-card" style={{padding:10}}><span style={{fontSize:12,fontWeight:700}}>Packer</span><input value={platformDefaults.Myntra.packer} onChange={e=>setPlatformDefaults(p=>({...p,Myntra:{...p.Myntra,[k]:e.target.value}}))}/></label>
        </div>}
...
{downloadReady&&generatedPreview.length>0&&<div className="listing-complete-card"><div className="complete-icon"><CheckCircle2 size={20}/></div><div><span className="eyebrow">STEP 3 · ECOMAI PRO AI EXCEL</span><h3>EcomAI Pro AI Excel ready</h3><p>This is the EcomAI Pro AI generated listing Excel. Download it now. Your original marketplace Excel will be uploaded separately in Step 4.</p></div><div className="complete-actions"><button className="primary" onClick={()=>downloadSimpleExcel()}>Download EcomAI Pro AI Excel <ArrowRight size={16}/></button></div></div>}
